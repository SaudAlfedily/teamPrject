package com.example.teamproject.ControllerAdvise;

import com.example.teamproject.ApiException.ApiException;
import com.example.teamproject.ApiResponse.ApiResponse;
...
public class ControllerAdvise {
    ...
    public ResponseEntity<ApiResponse> TransactionSystemException(TransactionSystemException e){
        ...
        String massage= e.getMessage();
        return ResponseEntity.status(400).body(new ApiResponse(massage+" there is prescription not assigned to patient "));
    }
}
